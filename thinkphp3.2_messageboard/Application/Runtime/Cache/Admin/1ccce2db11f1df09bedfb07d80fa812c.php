        ...
        <form method="post">
            ...
            <div class="form_input1">
                <div class="input-group">
                    ...
                    <input type="text" value="<?php echo ($message_info["m_title"]); ?>" class="form-control" placeholder="标题" aria-describedby="basic-addon1" name="m_title">
                </div>
            </div>
            <div class="form_input2">
                <span class="input-group-addon" >留言内容</span>
                <textarea class="form-control" rows="3" name="m_content"><?php echo ($message_info["m_content"]); ?></textarea>
            </div>
            <div class="form_input2">
                <span class="input-group-addon" >管理员回复</span>
                <textarea class="form-control" rows="3" name="m_replay"><?php echo ($message_info["m_replay"]); ?></textarea>
            </div>
                <button  type="submit" class="btn btn-primary btn">确认修改</button>
                <a class="btn_a" href="<?php echo U('showMessage');?>">返回查看留言信息</a>
        </form>
</div>
</body>
</html>