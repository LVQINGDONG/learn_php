    ...
    <div class="con">
        <form method="post">
            ...
            <div class="form_input">
                <span class="info_text">修改学生信息</span>
            </div>
            <div class="form_input">
                <div class="input-group">
                    <span class="input-group-addon" >学号</span>
                    <input type="text" value="<?php echo ($student_info["student_number"]); ?>" class="form-control" placeholder="学号" aria-describedby="basic-addon1" name="student_number">
                </div>
            </div>
            <div class="form_input">
                <div class="input-group">
                    <span class="input-group-addon" >姓名</span>
                    <input type="text" value="<?php echo ($student_info["student_name"]); ?>" class="form-control" placeholder="学生姓名" aria-describedby="basic-addon1" name="student_name">
                </div>
            </div>
            <div class="form_input">
                <div class="input-group">
                    <span class="input-group-addon" >出生</span>
                    <input type="text" value="<?php echo ($student_info["student_birthday"]); ?>" class="form-control" placeholder="年月日" aria-describedby="basic-addon1" name="student_birthday">
                </div>
            </div>
            <div class="form_input">
                <div class="input-group">
            ...
            <div class="form_input">
                <div class="input-group">
                    ...
                    <select name="class_id">
                        <?php if(is_array($major_info)): foreach($major_info as $key=>$v): if(is_array($v["Class"])): foreach($v["Class"] as $key=>$vv): ?><option value="<?php echo ($vv["class_id"]); ?>" <?php if(($student_info["class_id"]) == $vv["class_id"]): ?>selected<?php endif; ?>   >
